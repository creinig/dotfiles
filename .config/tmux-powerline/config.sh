...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="creinig"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/reiniger/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/reiniger/.mailcheckrc"
# }
