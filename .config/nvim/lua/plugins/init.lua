return {
...

  {
    ...
    config = function()
      ...
      -- Launch panel if nothing is typed after <leader>w
      ...
      vim.keymap.set("n", "<leader>wt", "<cmd>Telekasten show_tags<CR>")
      vim.keymap.set("n", "<leader>wj", "<cmd>Telekasten goto_today<CR>")
