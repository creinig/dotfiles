return {
  ...
  keys = {
    ...
    {"<leader>fdm",      ":FzfLua manpages<cr>",             desc = "[F]ind [D]ocumentation: [M]anpages"},
    ...
    {"<leader>fq",       ":FzfLua quickfix<cr>",             desc = "[F]ind [Q]uickfix list"},
    {"<leader>fl",       ":FzfLua loclist<cr>",              desc = "[F]ind [L]ocation list"},
